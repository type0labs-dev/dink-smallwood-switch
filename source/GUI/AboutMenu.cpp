...
#ifdef __SWITCH__
msg += "This product includes software developed by Seth A. Robinson ( www.rtsoft.com )\n\n";
msg += "Unofficial Switch homebrew port.\nData and saves: sdmc:/switch/dink-smallwood/\n\n";
#endif
if (IsDesktop())
{
