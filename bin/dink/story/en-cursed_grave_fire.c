// ========================================================
// en-cursed_grave_fire.c
// Dink Smallwood Definitive Edition (Nintendo Switch / PC)
// Criatura: Tumba das Chamas Eternas (cursed_grave_fire)
// Descricao: Cripta vulcânica que cospe chamas e mortos-vivos de fogo.
// ========================================================
...
void main( void )
{
    ...
    sp_base_walk(&current_sprite, 1190);
    sp_base_attack(&current_sprite, 1200);
    sp_base_death(&current_sprite, 1210);
...
void hit( void )
{
    ...
    if (&mhold == 1)
    {
        say("*Chamas jorram da tumba!*", &current_sprite);
    }
    if (&mhold == 2 && 1 > 1)
    {
        say("*Chamas jorram da tumba!*", &current_sprite);
...
void die( void )
{
    ...
    say("*Cripta destruída.*", &current_sprite);
