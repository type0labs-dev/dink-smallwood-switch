...
// Criatura: Esqueleto Guerreiro (skeleton)
// Descricao: Guerreiro esquelético com espada élfica e escudo cravado.
// ========================================================
...
void main( void )
{
    ...
    sp_base_attack(&current_sprite, 860);
...
void hit( void )
{
    ...
    if (&mhold == 1)
    {
        say("Apenas ossos... não sinto dor!", &current_sprite);
    }
    if (&mhold == 2)
    {
        say("Tsc! Minha carcaça ainda aguenta!", &current_sprite);
    }
}
...
void die( void )
{
    ...
    say("Voltarei... para a terra...", &current_sprite);
