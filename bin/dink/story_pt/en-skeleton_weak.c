...
// Criatura: Esqueleto Frágil (skeleton_weak)
// Descricao: Recruta esquelético desarmado, ataca com garras ósseas.
// ========================================================
...
void hit( void )
{
    ...
    if (&mhold == 1)
    {
        say("*Clac-clac!*", &current_sprite);
    }
    if (&mhold == 2 && 2 > 1)
    {
        say("Ossos soltos!", &current_sprite);
    }
}
...
void die( void )
{
    ...
    say("*Desmorona em pó...*", &current_sprite);
