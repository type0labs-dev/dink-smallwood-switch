void main( void )
{
 ...
 wait(400);
 sp_dir(1, 2);
 say_stop("Escuta! Tem alguém vindo!", 1);
 move_stop(1, 4, 468, 1);
 move_stop(1, 2, 269, 1);
 wait(500);
 playmidi("1004.mid");
 ...
 move(&evil2, 6, 130, 1);
 wait(1000);
 say_stop("Ei, esses são alguns daqueles malditos cavaleiros de Cast.", 1);
 move(&evil2, 9, 150, 1);
 move(&evil, 1, 115, 1);
 wait(250);
 move(&evil2, 4, 100, 1);
 say_stop("Que diabos eles tão fazendo aqui?", 1);
 wait(750);
 //They say stuff
 say_stop("`7A área tá limpa, pronto pra voltar.", &evil2);
 wait(500);
 say_stop("`5Acho que a gente vai conseguir saquear a vila durante o festival.", &evil);
 wait(250);
 say_stop("`7Ótimo, tudo dentro do cronograma. E a culpa não vai sobrar pra gente...", &evil2);
 wait(250);
 say_stop("`5Isso. Já falou com o Mog?", &evil);
 wait(250);
 say_stop("`7Sim. Mandamos o Joon, o arqueiro. Ele fala a língua deles bem.", &evil2);
 wait(250);
 ...
 move_stop(1, 4, 300, 1);
 wait(500);
 say_stop("Cara, saquear uma vila!?!", 1);
 wait(400);
 say_stop("Um bando desses caras ia detonar tudo.", 1);
 sp_dir(1, 2);
 say_stop("Eles falaram de um festival...", 1);
 wait(400);
 say_stop("...será que é por aqui?", 1);
 &story = 9;
