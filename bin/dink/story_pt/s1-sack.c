...
void hit(void)
{
Say("Eu te odeio, seu saco de ração!", 1);
}

void talk(void)
{
Say("Um saco grandão.", 1);
}
...
say("Agora tô com um saco de ração de porco.", 1);
...
show_popup("interface/iphone/quicktip_saving.rttex", 4000);
