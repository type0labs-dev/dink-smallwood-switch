...
if (&return == 1)
{
	...
	if (&return == 1)
    {
		...
		if (&return == 1)
		{
				...
				if (&return == 1)
				{
				  ...
				  title_start();
				  -*- Missões Secundárias -*-
				  	Devo exterminar os monstros na fazenda do Smilestein, visitar minha tia em Terris, ajudar um sujeito suspeito num trabalho a oeste da taverna de Terris e resgatar o bonca de estimacao perdido na Floresta Murkwood.
					title_end();
					"Missões principais"
					"Missões concluídas"
					"Voltar"
			  ...
			  title_start();
			  -*- Missões Secundárias -*-
			  Devo exterminar os monstros na fazenda do Smilestein, visitar minha tia em Terris e ajudar um sujeito suspeito num trabalho a oeste da taverna de Terris.
				title_end();
				"Missões principais"
				"Missões concluídas"
				"Voltar"
		...
		if (&return == 1)
		{
		  ...
		  title_start();
		  -*- Missões Secundárias -*-
		  	Devo exterminar os monstros na fazenda do Smilestein, visitar minha tia em Terris e resgatar o bonca de estimacao perdido na Floresta Murkwood.
			title_end();
			"Missões principais"
			"Missões concluídas"
			"Voltar"
	...
	if (&return == 1)
    {
		...
		if (&return == 1)
		{
		  ...
		  title_start();
		  -*- Missões Secundárias -*-
		  	Devo exterminar os monstros na fazenda do Smilestein, ajudar um sujeito suspeito num trabalho a oeste da taverna de Terris e resgatar o bonca de estimacao perdido na Floresta Murkwood.
			title_end();
			"Missões principais"
			"Missões concluídas"
			"Voltar"
  ...
  if (&return == 1)
  {
    ...
    if (&return == 1)
    {
		...
		if (&return == 1)
		{
		  ...
		  title_start();
		  -*- Missões Secundárias -*-
		  Devo visitar minha tia em Terris, ajudar um sujeito suspeito num trabalho a oeste da taverna de Terris e resgatar o bonca de estimacao perdido na Floresta Murkwood.
			title_end();
			"Missões principais"
			"Missões concluídas"
			"Voltar"
