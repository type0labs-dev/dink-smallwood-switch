...
// Criatura: Minotauro Brutal (minotaur)
// Descricao: Chefe imponente com machado pesado de duas mãos e giro demolidor.
// ========================================================
...
void hit( void )
{
    ...
    if (&mhold == 1)
    {
        say("MUUUAAARGH! Isso só me enfurece!", &current_sprite);
    }
    if (&mhold == 2)
    {
        say("Você ousa arranhar meu couro, humano?!", &current_sprite);
    }
}
...
void die( void )
{
    ...
    say("O labirinto... me chama...", &current_sprite);
